...
class Material : public Clonable<Material> {
 ...
 public:
  ...
  //----------------------------------------------------------------------------
  virtual vec3 shade(const Light& l, const Intersection& i) const = 0;
  //----------------------------------------------------------------------------
  ...
  /// mirror.
  auto reflectance() const { return m_reflectance; }
  ...
  auto refractance() const { return m_refractance; }
  void set_refractance(const double refractance) {
    m_refractance = refractance;
  }
  //----------------------------------------------------------------------------
  auto index_of_refraction() const { return m_index_of_refraction; }
  auto set_index_of_refraction(const double ior) {
    return m_index_of_refraction = ior;
  }
  //----------------------------------------------------------------------------
  /// Sample the albedo (diffuse) color of the material 
